...
import com.simba.order.service.domain.exception.OrderNotFoundException;
...
public class OrderTrackCommandHandler {
    ...
    public TrackOrderResponse trackOrder(TrackOrderQuery trackOrderQuery) {
        Optional<Order> orderResult = orderRepository.findByTrackingId(new TrackingIdVO(trackOrderQuery.getOrderTrackingId()));
