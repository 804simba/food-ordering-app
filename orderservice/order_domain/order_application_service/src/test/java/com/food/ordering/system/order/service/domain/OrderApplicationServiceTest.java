...
import com.simba.order.service.domain.entity.Customer;
...
public class OrderApplicationServiceTest {
    ...
    void init () {
        ...
        customer.setId(new CustomerIdVO(CUSTOMER_ID));
        ...
        Restaurant restaurantResponse = Restaurant.Builder.builder()
                ...
                .products(List.of(new Product(new ProductIdVO(PRODUCT_ID), "product-1",
                        new MoneyVO(new BigDecimal("50.00"))),
                        new Product(new ProductIdVO(PRODUCT_ID), "product-2",
                                new MoneyVO(new BigDecimal("50.00")))))
                .active(true)
                .build();

        Order order = orderDataMapper.createOrderCommandToOrder(createOrderCommand);
        order.setId(new OrderIdVO(ORDER_ID));
    ...
    public void testCreateOrder() {
        ...
        assertEquals( OrderStatusVO.PENDING, createOrderResponse.getOrderStatus());
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals("Order item price: is not valid for product",
                orderDomainException.getMessage());
    }
